...
// Create instances of Classroom3 and add students to them
const classroom1 = new Classroom3();
classroom1.addStudent(new Student4(1, "Alice"));
classroom1.addStudent(new Student4(2, "Bob"));
classroom1.addStudent(new Student4(3, "Charlie"));
